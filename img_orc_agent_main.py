...
class ImageFeatureExtractor:
    ...
    def process_image(self, image_path: str) -> Dict[str, Any]:
        ...
        result = {
            ...
            "is_nsfw": signals.get("is_nsfw", False)
        }
    ...
    def process(self, image_paths: List[str]) -> Dict[str, Any]:
        ...
        for image_path in image_paths:
            ...
            try:
                ...
                is_nsfw = features.get('is_nsfw', False)
        ...
        print(f"  Images with NSFW: {images_with_nsfw}")
        if failed_images > 0:
        ...
        final_results = {
            ...
            "feature_extraction_summary": {
                ...
                "images_with_nsfw": images_with_nsfw,
                ...
                "nsfw_detection_rate": f"{(images_with_nsfw/images_processed*100):.1f}%" if images_processed > 0 else "0%"
            },
...
def main():
    ...
    print(f"   NSFW detected: {results['feature_extraction_summary']['images_with_nsfw']}")
